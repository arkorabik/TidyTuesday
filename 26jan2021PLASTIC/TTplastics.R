...
#ldpe - Low density polyethylene count (Plastic bags, Ziploc bags, buckets, squeeze bottles, plastic tubes, chopping boards)
...
#Americas = p2 %>% 
  #filter(country == "Argentina" & "Brazil" & "Colombia" & "ECUADOR" & "Canada" & "Mexico" & "United States of America")
...
?ochre_pal
#how to see the colors in a palette
library(scales)
